...
const TRANSLATIONS = {
  ...
  ja: {
    ...
    loginErrPinTooShort: 'あいことばは 4もじ以上にしてね。',
  ...
  en: {
    ...
    loginPinLabel: 'Secret word (4+ characters)',
    ...
    loginErrPinTooShort: 'The secret word must be at least 4 characters.',
  ...
  elementary: {
    ...
    loginNameLabel: 'なまえ（ニックネームでもOK）',
    loginNamePh: '（あなたのなまえ）',
    loginPinLabel: 'あいことば（4もじ以上（いじょう））',
    loginPinPh: '（ひみつのことば）',
    loginPinShow: '見（み）る',
    loginPinHide: 'かくす',
    loginSubmitRegister: 'これで はじめる →',
    ...
    loginErrPinTooShort: 'あいことばは 4もじ以上（いじょう）にしてね。',
    loginErrNameTaken: 'その なまえは もう つかわれているよ。ほかの なまえにしてね。',
    loginErrBadCredentials: 'あいことばが ちがうみたい。もういちど ためしてね。',
    loginErrNotFound: 'その なまえは まだ ないよ。「なまえを つくる」から はじめてね。',
    loginTitleUnified: 'なまえと あいことばを いれてね',
