...
export const CITIES = [
  ...
  },
  {
    ...
    lines: [
      ...
      { name: '名古屋市営地下鉄 桜通線',  nameEn: 'Nagoya Subway Sakura-dori Line',
        stations: ['太閤通', '名古屋', '国際センター', '丸の内', '久屋大通', '高岳', '車道', '今池', '吹上', '御器所', '桜山', '瑞穂区役所', '瑞穂運動場西', '新瑞橋', '桜本町', '鶴里', '野並', '徳重'] },
  ...
  },
  {
    ...
    lines: [
      ...
      { name: '大阪メトロ四つ橋線', nameEn: 'Osaka Metro Yotsubashi Line',
        stations: ['西梅田', '肥後橋', '本町', '四ツ橋', 'なんば', '大国町', '花園町', '岸里', '玉出', '北加賀屋', '住之江公園'] },
      { name: '大阪メトロ中央線',   nameEn: 'Osaka Metro Chuo Line',
        stations: ['コスモスクエア', '大阪港', '朝潮橋', '弁天町', '九条', '阿波座', '本町', '堺筋本町', '谷町四丁目', '森ノ宮', '緑橋', '深江橋', '高井田', '長田'] },
      { name: '大阪メトロ千日前線', nameEn: 'Osaka Metro Sennichimae Line',
        stations: ['野田阪神', '玉川', '阿波座', '桜川', 'なんば', '日本橋', '谷町九丁目', '鶴橋', '今里', '新深江', '小路', '北巽', '南巽'] },
      { name: '大阪メトロ堺筋線',   nameEn: 'Osaka Metro Sakaisuji Line',
        stations: ['天神橋筋六丁目', '扇町', '南森町', '北浜', '堺筋本町', '長堀橋', '日本橋', '恵美須町', '天下茶屋'] },
      { name: '大阪メトロ長堀鶴見緑地線', nameEn: 'Osaka Metro Nagahori Tsurumi-ryokuchi Line',
        stations: ['大正', 'ドーム前千代崎', '西長堀', '西大橋', '心斎橋', '長堀橋', '松屋町', '谷町六丁目', '玉造', '森ノ宮', '大阪ビジネスパーク', '京橋', '蒲生四丁目', '今福鶴見', '横堤', '鶴見緑地', '門真南'] },
      { name: '大阪メトロ今里筋線', nameEn: 'Osaka Metro Imazatosuji Line',
        stations: ['井高野', '瑞光四丁目', 'だいどう豊里', '太子橋今市', '清水', '新森古市', '関目成育', '蒲生四丁目', '今福鶴見', '諏訪', '鴫野', '緑橋', '今里'] },
...
export const STATION_NAMES_EN = {
  ...
  // 桜通線
  '太閤通': 'Taikodori', '国際センター': 'Kokusai Center',
  ...
  '高槻市': 'Takatsuki-shi',
  // 四つ橋線
  '西梅田': 'Nishi-Umeda', '肥後橋': 'Higobashi', '四ツ橋': 'Yotsubashi', '花園町': 'Hanazonocho',
  '岸里': 'Kishinosato', '玉出': 'Tamade', '北加賀屋': 'Kita-Kagaya', '住之江公園': 'Suminoe-koen',
  // 中央線
  'コスモスクエア': 'Cosmosquare', '大阪港': 'Osakako', '朝潮橋': 'Asashiobashi', '九条': 'Kujo',
  '阿波座': 'Awaza', '堺筋本町': 'Sakaisuji-Hommachi', '緑橋': 'Midoribashi', '深江橋': 'Fukaebashi',
  '高井田': 'Takaida', '長田': 'Nagata',
  // 千日前線
  '野田阪神': 'Noda-Hanshin', '玉川': 'Tamagawa', '桜川': 'Sakuragawa', '日本橋': 'Nippombashi',
  '今里': 'Imazato', '新深江': 'Shin-Fukae', '小路': 'Shoji', '北巽': 'Kita-Tatsumi', '南巽': 'Minami-Tatsumi',
  // 堺筋線
  '扇町': 'Ogimachi', '北浜': 'Kitahama', '長堀橋': 'Nagahoribashi', '恵美須町': 'Ebisucho', '天下茶屋': 'Tengachaya',
  // 長堀鶴見緑地線
  'ドーム前千代崎': 'Dome-mae Chiyozaki', '西長堀': 'Nishi-Nagahori', '西大橋': 'Nishi-Ohashi',
  '松屋町': 'Matsuyamachi', '大阪ビジネスパーク': 'Osaka Business Park', '蒲生四丁目': 'Gamo-yonchome',
  '今福鶴見': 'Imafuku-Tsurumi', '横堤': 'Yokozutsumi', '鶴見緑地': 'Tsurumi-ryokuchi', '門真南': 'Kadoma-minami',
  // 今里筋線
  '井高野': 'Ikadano', '瑞光四丁目': 'Zuiko-yonchome', 'だいどう豊里': 'Daido-Toyosato', '清水': 'Shimizu',
  '新森古市': 'Shinmori-Furuichi', '関目成育': 'Sekime-Seiiku', '諏訪': 'Suwa', '鴫野': 'Shigino',
...
export const STATION_NAMES_KANA = {
  ...
  '高槻市': 'たかつきし',
  '西梅田': 'にしうめだ', '肥後橋': 'ひごばし', '四ツ橋': 'よつばし', '花園町': 'はなぞのちょう',
  '岸里': 'きしのさと', '玉出': 'たまで', '北加賀屋': 'きたかがや', '住之江公園': 'すみのえこうえん',
  'コスモスクエア': 'こすもすくえあ', '大阪港': 'おおさかこう', '朝潮橋': 'あさしおばし', '九条': 'くじょう',
  '阿波座': 'あわざ', '堺筋本町': 'さかいすじほんまち', '緑橋': 'みどりばし', '深江橋': 'ふかえばし',
  '高井田': 'たかいだ', '長田': 'ながた',
  '野田阪神': 'のだはんしん', '玉川': 'たまがわ', '桜川': 'さくらがわ', '日本橋': 'にっぽんばし',
  '今里': 'いまざと', '新深江': 'しんふかえ', '小路': 'しょうじ', '北巽': 'きたたつみ', '南巽': 'みなみたつみ',
  '扇町': 'おうぎまち', '北浜': 'きたはま', '長堀橋': 'ながほりばし', '恵美須町': 'えびすちょう', '天下茶屋': 'てんがちゃや',
  'ドーム前千代崎': 'どーむまえちよざき', '西長堀': 'にしながほり', '西大橋': 'にしおおはし',
  '松屋町': 'まつやまち', '大阪ビジネスパーク': 'おおさかびじねすぱーく', '蒲生四丁目': 'がもうよんちょうめ',
  '今福鶴見': 'いまふくつるみ', '横堤': 'よこづつみ', '鶴見緑地': 'つるみりょくち', '門真南': 'かどまみなみ',
  '井高野': 'いだかの', '瑞光四丁目': 'ずいこうよんちょうめ', 'だいどう豊里': 'だいどうとよさと', '清水': 'しみず',
  '新森古市': 'しんもりふるいち', '関目成育': 'せきめせいいく', '諏訪': 'すわ', '鴫野': 'しぎの',
