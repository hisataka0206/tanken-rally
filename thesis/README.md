...
| `../docs/char-lab-howto.md` | char-lab の操作手順・sweep設計 |
| `../docs/character-form-first-design.md` | 介入の設計原則（14フォルム・形に出る特徴） |
| `../docs/pokemon-character-design-analysis.md` | 参照ロスターの役割分担分析 |
| `../docs/character-image-generation-rules.md` | negation backfire の一次記録 |
...
| `../docs/character-taxonomy/` | 記述語彙DB・5軸分析（公式体型・rarity・色・タイプ） |
...
- 生成に使ったスプライト類・ZIPは `.gitignore` でローカル限定（`gen1/`, `pokemon_all/`, `thesis/data/zip/`, `thesis/experiment/stimuli/`）。
