...
const TRANSLATIONS = {
  ...
  ja: {
    ...
    region_kobe: '神戸', region_kyoto: '京都', region_hamamatsu: '浜松', region_other: 'その他',
  ...
  en: {
    ...
    region_kobe: 'Kobe', region_kyoto: 'Kyoto', region_hamamatsu: 'Hamamatsu', region_other: 'Other',
  ...
  elementary: {
    ...
    region_kobe: '神戸（こうべ）', region_kyoto: '京都（きょうと）', region_hamamatsu: '浜松（はままつ）', region_other: 'そのほか',
    regionAreaFmt: '{region}エリア',
