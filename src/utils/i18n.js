...
const TRANSLATIONS = {
  ...
  elementary: {
    ...
    disclaimer: '<strong>すべての駅で、ちゃんとしたコースが用意（ようい）されていることを約束（やくそく）していません。</strong> スポットが少なかったり、目安（めやす）の時間（やく60分）におさまらないこともあります。気（き）になったら別（べつ）の駅もためしてみてね。',
    ...
    filterStart: '開始（かいし）',
    filterEnd: '終了（しゅうりょう）',
    filterDisclaimer: '営業（えいぎょう）時間（じかん）の情報（じょうほう）は <strong>Google マップの情報（じょうほう）にたよっています</strong>。正確（せいかく）であることを約束（やくそく）するものではありません。じっさいに行く前（まえ）に、お店（みせ）やしせつの公式（こうしき）サイトや電話（でんわ）で必（かなら）ずたしかめてください。',

    catFilterLabel: 'しゅるいでしぼりこむ:',
    ...
    photoGalleryLabel: '写真（しゃしん）をえらぶ',
    photoHint: '撮影（さつえい）したあとに写真（しゃしん）をタップして、場所のタグ（任意（にんい））をつけられるよ。',
    btnWizardPrev: '← 前（まえ）へ',
    btnWizardToMap: '← マップ',
    btnWhere: 'まよったら…いまどこ？（点（てん）がすこしへる）',
    whereTitle: 'いまどこ？',
    whereLocating: 'いまの場所（ばしょ）をさがしているよ…',
    whereFound: '青（あお）い矢印（やじるし）が「あなた」。矢印（やじるし）のむきが、向（む）いている方向（ほうこう）だよ。',
    whereHint: '※これは こまったとき用（よう）。つかうと 点（てん）がすこし へるよ。',
    whereYou: 'あなた',
    whereGpsError: '場所（ばしょ）が うまく とれなかったよ。空（そら）の見（み）えるところで ためしてね。',
    whereNoGps: 'この端末（たんまつ）では 場所（ばしょ）が つかえないみたい。',
    whereMapError: '地図（ちず）が よみこめなかったよ。',
    ...
    reportSecCharacters: '今回（こんかい）であったキャラたち',
    reportCaptureBadgeFmt: '{name}を つかまえた！',
    adviceCatchChars: 'ARカメラでキャラをさがして つかまえると、スコアが大きくアップするよ',
    adviceCatchMoreChars: 'まだ出会（であ）っていないキャラがいるみたい。いろんなスポットでさがしてみよう（いま {n} 体（たい）ゲットずみ）',
    ...
    speechSpots: '行（い）きたい場所（ばしょ）をえらんでね！',
    speechRoute: 'ルートができたよ！かんぺきだ！',
    speechPhotos: '写真（しゃしん）をとって思（おも）い出（で）あつめよう！',
    speechReport: 'きょうの冒険（ぼうけん）をノートにのこそう！',
    pickerLine: 'ろせんをえらぶ',
    pickerStation: 'えきをえらぶ',
    ...
    loginTitleRegister: 'はじめまして！なまえを つくろう',
    loginTitleLogin: 'おかえり！ログインしよう',
    loginLead: 'なまえと あいことばを きめると、じぶんだけの図鑑（ずかん）ができるよ。',
    loginLeadLogin: 'まえに つくった なまえと あいことばを入（い）れてね。',
    loginNameLabel: 'なまえ（ニックネームでもOK）',
    loginNamePh: '（あなたのなまえ）',
    loginPinLabel: 'あいことば（6もじ以上（いじょう））',
    loginPinPh: '（ひみつのことば）',
    loginPinShow: '見（み）る',
    loginPinHide: 'かくす',
    loginSubmitRegister: 'これで はじめる →',
    loginSubmitLogin: 'ログイン →',
    loginWorking: 'ちょっと まってね…',
    loginSwitchToLogin: 'もう なまえを つくった人（ひと）は',
    loginSwitchToLoginBtn: 'ログイン',
    loginSwitchToRegister: 'はじめての人（ひと）は',
    loginSwitchToRegisterBtn: 'なまえを つくる',
    loginNote: '※あいことばは、じぶんの図鑑（ずかん）をまもる ひみつのことば。わすれないでね。',
    loginErrNameRequired: 'なまえを 入（い）れてね。',
    loginErrNameTooLong: 'なまえが 長（なが）すぎるよ（20もじまで）。',
    loginErrPinTooShort: 'あいことばは 6もじ以上（いじょう）にしてね。',
    loginErrNameTaken: 'その なまえは もう つかわれているよ。ほかの なまえにしてね。',
    loginErrBadCredentials: 'あいことばが ちがうみたい。もういちど ためしてね。',
    loginErrNotFound: 'その なまえは まだ ないよ。「なまえを つくる」から はじめてね。',
    loginTitleUnified: 'なまえと あいことばを いれてね',
    loginLeadUnified: 'はじめての人（ひと）は じどうで つくられるよ。まえに つくった人（ひと）は そのまま入（はい）れるよ。',
    loginSubmitUnified: 'はじめる →',
    loginErrMismatch: 'あいことばが ちがうか、その なまえは もう つかわれています。',
    loginErrTooMany: 'あいことばを 何回（なんかい）も まちがえたよ。15分（ふん）たってから もういちど ためしてね。',
    homeStart: 'たんけんを はじめる',
    homeHistory: 'いままでの たんけんを 思（おも）い出（だ）す',
    homeZukan: 'ずかんを 見（み）る',
    homeGrow: '育（そだ）てる（仮）',
    homeGrowBadge: '作成中（さくせいちゅう）',
    growTitle: '育（そだ）てる（仮）',
    growBadge: '作成中（さくせいちゅう）',
    growLead: 'つかまえた なかまを おうちで 育（そだ）てられる、あたらしい あそびを じゅんびしているよ。',
    growGoal: '目標（もくひょう）は 100人（にん）！ みんなで あそべる日（ひ）を めざしてるよ。',
    growMilestoneNearFmt: 'のこり {n}人（にん）！ もうすぐ解放（かいほう）だよ！',
    growMilestoneLastFmt: 'ラストスパート！ のこり {n}人（にん）！',
    growMilestoneDateFmt: '（{date} 時点（じてん））',
    growUnlock: '100人（にん）いじょうの お友（とも）だちが あそんでくれる頃（ころ）に できあがるよ。お友（とも）だちを さそって、はやく 解放（かいほう）しよう！',
    growClose: 'たのしみに まってるね！',
    homeHelloFmt: 'ようこそ、{name}さん！',
    btnHome: 'トップにもどる',
    loginErrNetwork: 'つうしんに しっぱいしたよ。もういちど ためしてね。',
    ...
    homePolicy: '利用規約・プライバシー',
    genReport: 'このキャラを報告',
    homeReport: 'ふぐあい・おといあわせ',
    reportIssueTitle: 'ほうこく・おといあわせ',
    reportIssueLead: 'こまったこと・へんなキャラ・けしてほしいことを おしえてね。がぞうも つけられるよ。',
    reportIssueType: 'しゅるい',
    reportIssueTypeBug: 'ふぐあいの ほうこく',
    reportIssueTypeChar: 'キャラの ほうこく',
    reportIssueTypeDelete: 'しゃしん・データの さくじょ',
    reportIssueTypeOther: 'そのほか',
    reportIssueDetail: 'ないよう',
    reportIssueDetailPh: 'くわしく おしえてね',
    reportIssueImage: 'がぞう（あれば・にんい）',
    reportIssueContact: 'れんらくさき（にんい）',
    reportIssueContactPh: 'メールなど（へんしんが ひつような ばあい）',
    reportIssueSend: 'おくる →',
    reportIssueSending: 'おくっているよ…',
    reportIssueThanks: 'おくったよ！ ありがとう。',
    reportIssueFailed: 'おくれなかったよ。あとで もういちど ためしてね。',
    reportIssueNeedInput: 'ないよう か がぞうを 入れてね。',
    reportIssueNoServer: 'いまは おくれないよ（せつぞくなし）。',
    logoutConfirm: 'ログアウトする？（図鑑（ずかん）は なまえと あいことばで また 見（み）られるよ）',
    chargenEntryLead: 'きょうの たんけんから あたらしい なかまが つくれるよ！',
    chargenStart: 'あたらしい なかまを むかえる →',
    chargenLoading: 'なかまを さがしてるよ…',
    chargenPickTitle: 'どの なかまに する？',
    chargenPickSub: 'かげを よく見（み）て、ひとつ えらんでね',
    chargenRevealTitle: 'あたらしい なかま とうじょう！',
    chargenNameSub: 'なまえを えらんでね',
    chargenSave: 'ずかんに とうろく →',
    chargenDoneFmt: '「{name}」を なかまに した！',
    ...
    historyLoginRequired: 'ログインすると、じぶんの冒険（ぼうけん）の履歴（りれき）が見（み）られるよ。',
    resumeIndicatorFmt: 'さいかい中（ちゅう）のぼうけん: {name}',
    chargenBrewingToast: 'なかまを つくっているよ！ スコアのあとで あえるよ',
    historyOpenFolder: 'ひらく',
    historyResume: 'つづき',
    ...
    btnZukan: 'キャラずかん',
    zukanTitle: 'キャラずかん',
    zukanDesc: 'たんけん中（ちゅう）にARカメラでつかまえたキャラのコレクションだよ。つかまえたキャラをタップすると、ひみつのストーリーが読（よ）めるよ！',
    zukanUnknown: '？？？',
    zukanCaughtFmt: '{n}回（かい） つかまえた',
    variant_normal: 'ノーマル',
    variant_mini: 'ちび',
    variant_jumbo: 'でか',
    variant_shiny: 'ビンテージ',
    ...
    zukanCompFmt: 'コンプ {n}/{total}',
    zukanVariantsTitle: 'すがた',
    zukanRevealHintFmt: 'あと{left}回（かい）つかまえると もっと読（よ）めるよ（今（いま） {pct}%）',
    zukanRevealFull: 'ぜんぶ読（よ）めた！',
    btnBackRoute: '← マップにもどる',
    btnFinishExplore: '探検（たんけん）おわり！ノートへ →',

    reportIntro: '自分（じぶん）のことばで、感（かん）じたこと・見（み）つけたこと・気（き）になったことを書（か）いてみよう。PDFにして印刷（いんさつ）すると、B3ポスターサイズのたんけんノートになるよ。',
    reportTitleH1: 'たんけんノート',
    reportDate: 'たんけん日',
    reportAuthor: 'きろくした人',
    reportAuthorPh: '（あなたの名前）',
    ...
    tidyMemosDone: 'ひと言（こと）メモをすっきりさせました（「 メモを元（もと）にもどす」でいつでももどせます）',
    ...
    voiceMemoDesc: 'マイクのボタンをおして、気（き）づいたことを声（こえ）で話（はな）してみよう。あとから書（か）きなおしてもOK。',
    voiceMethodLabel: '音声（おんせい）にんしきのほうしき：',
    voiceMethodWebspeech: '標準（ひょうじゅん）（すぐ・むりょう）',
    voiceMethodWhisper: '高精度（こうせいど）（Whisper）',
    voiceMicStart: 'おして話（はな）す',
    voiceMicStop: '話（はな）しおわり',
    voiceMemoPh: '声（こえ）のメモがここに入（はい）るよ（手（て）で書（か）いてもOK）',
    voiceMemoSkip: 'スキップ',
    voiceMemoSave: '保存（ほぞん）',
    voiceStatusListening: '聞（き）いています…話（はな）してね',
    voiceStatusRecording: 'ろくおん中（ちゅう）…話（はな）しおわったら、もういちどボタンをおしてね',
    voiceStatusTranscribing: '文字（もじ）にしています…',
    voiceStatusNoSpeech: '声（こえ）が聞（き）きとれませんでした。もういちどためしてね。',
    voiceStatusError: '音声（おんせい）にんしきでエラーがありました。もういちどためしてね。',
    voiceStatusMicDenied: 'マイクが使（つか）えませんでした。ブラウザのマイクのきょかをかくにんしてね。',
    voiceNoteWebspeechUnsupported: 'このたんまつでは「標準（ひょうじゅん）」が使（つか）えないので「高精度（こうせいど）（Whisper）」がおすすめだよ。',
    voiceNoteRecordingUnsupported: 'このたんまつではろくおんが使（つか）えません。「標準（ひょうじゅん）」をためしてね。',
    voiceNoteNoKey: 'OpenAIのAPIキーがないので「高精度（こうせいど）」は使（つか）えません。「標準（ひょうじゅん）」をためしてね。',

    scoreModalTitle: 'たんけんスコア',
    scorePlanLabel: '計画点（けいかくてん）',
    scoreExecLabel: '実行点（じっこうてん）',
    scoreSplitNote: '計画点（けいかくてん）（100点（てん）まんてん）＝1時間（じかん）でまわるのにちょうどいいスポットの数（かず）に、どれだけ近（ちか）づけたか。まんてんのきじゅんは駅（えき）やルートでかわるよ。 ／ 実行点（じっこうてん）＝じっさいにどれだけ楽（たの）しめたか（写真（しゃしん）・コメント・ペース・キャラつかまえ　など）',
    scoreNameLabel: '名前（ニックネームでもOK）',
    ...
    scoreHowtoList: '<li> たくさん歩（ある）く</li><li> いろんなスポットに行（い）く</li><li> 写真（しゃしん）をたくさん撮（と）る</li><li> 写真にスポットの名前（なまえ）タグを付（つ）ける</li><li> 感想（かんそう）や写真のコメントを書（か）く</li><li> 1時間（じかん）いないにおわらせる</li><li> Googleの時間（じかん）に近（ちか）いペースで歩（ある）く</li><li> ARカメラでキャラをつかまえる（レアはボーナス！）</li>',
    scoreAdviceTitle: 'こうするともっと点（てん）がのびるかも！',
    adviceMorePhotos: '写真（しゃしん）をもう少（すこ）し撮（と）ってみよう（{n}まい → 5まい以上（いじょう）が目安（めやす））',
    adviceTagPhotos: '写真（しゃしん）にスポットのタグを付（つ）けると点（てん）がのびるよ（タグつき {n}/{total}まい）',
    adviceMoreComments: '写真（しゃしん）の感想（かんそう）を書（か）いてみよう（コメント {n}まい／{total}まい）',
    adviceLongerOverview: '「ぜんたいの感想（かんそう）」をもう少（すこ）し書（か）いてみよう（いま {n}文字（もじ））',
    adviceUnder60: '1時間（じかん）いないにおわらせると大（おお）きなボーナスがあるよ（今回（こんかい） {min}分（ふん））',
    ...
    originStoryPrefix: 'たんけん博士（はかせ）より：',
...
export const WIZARD_SPOT_HINTS = {
  ...
  elementary: {
    ...
    museum: [
      ...
      '印象（いんしょう）にのこったてんじを撮（と）ろう（フラッシュ禁止（きんし）に注意（ちゅうい））',
